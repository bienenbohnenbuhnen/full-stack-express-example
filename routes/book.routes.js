...
//GET ROUTE TO DISPLAY FORM <-- NEEDS TO COME ABOVE :bookId bit otherwise it will be processed as a parameter and won't work
router.get("/books/create", (req, res) => res.render("books/book-create.hbs"));

//POST ROUTE TO SAVE NEW BOOK TO DB
